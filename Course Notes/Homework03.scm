...
; IH: We are inducting on # of digits in n, if the n >= 0 is an integer, then the recursive call will return the correct result
; BASIS: Return n when n is a 1-digit nonnegative integer
; IS
...
; iii) zero? nyp returns result, which checks NYP = 0.
;; STRONG ENOUGH? Yes, when NYP has become 0, our program returns result which is the AP; in other words, result = AP, NYP = 0. 
